...
tmux split-window -v -t $SESSION "pixi run -e humble ros2 launch robot_ik_layer start_ijk.launch.py spawn_franka_left:=false spawn_franka_right:=true bypass_safety:=true ; exec bash"
